...
/**
one step of the optimization alternating between local and global solve, 
 - data and K from precomputation, 
 - bc the value of the handles, 
 - U the updated vertices.
*/
